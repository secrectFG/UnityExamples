...
public class MsgType
{
    ...
    public const string CLIENT_MAIL_SEND_ACK                = "CLIENT_MAIL_SEND_ACK";               //邮件发送回应
    ...
    public const string CLIENT_GUILD_MEMBER_QUERY_ACK       = "CLIENT_GUILD_MEMBER_QUERY_ACK";      //公会玩家信息查询回应
    ...
    public const string CLIENT_AGENT_QUERY_INFO_ACK         = "CLIENT_AGENT_QUERY_INFO_ACK";        //查询我的推广信息回应
    public const string CLIENT_AGENT_QUERY_SUB_AMOUNT_ACK   = "CLIENT_AGENT_QUERY_SUB_AMOUNT_ACK";  //查询子账号数量回应
    public const string CLIENT_AGENT_QUERY_SUB_LIST_ACK     = "CLIENT_AGENT_QUERY_SUB_LIST_ACK";    //查询子账号的贡献列表回应
    public const string CLIENT_AGENT_QUERY_USER_ACK         = "CLIENT_AGENT_QUERY_USER_ACK";        //查询某个玩家详细贡献回应
    public const string CLIENT_MAIL_GIFT_SEND_ACK           = "CLIENT_MAIL_GIFT_SEND_ACK";          //赠送邮件礼物回应    
    public const string CLIENT_MAIL_GIFT_LOG_QUERY_ACK      = "CLIENT_MAIL_GIFT_LOG_QUERY_ACK";     //礼物赠送日志查询回应
    public const string CLIENT_LAST_GAME_CLEAR              = "CLIENT_LAST_GAME_CLEAR";             //上次未结束的游戏已结束
    public const string CLIENT_RANK_REWARD_FETCH_ACK        = "CLIENT_RANK_REWARD_FETCH_ACK";       //领取排行榜奖励回应
    public const string CLIENT_TREASURE_GAME_BALANCE_ACK    = "CLIENT_TREASURE_GAME_BALANCE_ACK";   //聚宝盆小游戏结算回应
    public const string CLIENT_TREASURE_BALANCE_SHOW        = "CLIENT_TREASURE_BALANCE_SHOW";       //聚宝盆结算后轮盘显示
    public const string CLIENT_GET_SERVICE_ACK              = "CLIENT_GET_SERVICE_ACK";             //获取客服信息
    public const string CLIENT_GAME_RECONNECTED             = "CLIENT_GAME_RECONNECTED";            //游戏断线重连完成
    public const string CLIENT_MAGIC_TRADE_IN_ACK           = "CLIENT_MAGIC_TRADE_IN_ACK";          //弹头兑换魔力值回应
    public const string CLIENT_MAGIC_TRADE_OUT_ACK          = "CLIENT_MAGIC_TRADE_OUT_ACK";         //魔力值兑换弹头回应
    public const string CLIENT_PLAYER_MAGIC_CHANGED         = "CLIENT_PLAYER_MAGIC_CHANGED";        //魔力值变化
    public const string CLIENT_WARHEAD_EXCHANGE_ACK         = "CLIENT_WARHEAD_EXCHANGE_ACK";        //弹头交换回应
    //#endregion
    ...
    public const string NET_MAIL_SEND_ACK                   = "NET_MAIL_SEND_ACK";                  //邮件发送回应
    ...
    public const string NET_GUILD_QUERY_MEMBERS_ACK         = "NET_GUILD_QUERY_MEMBERS_ACK";        //获取公会成员信息回应
    public const string NET_GUILD_MEMBER_QUERY_ACK          = "NET_GUILD_MEMBER_QUERY_ACK";         //公会玩家信息查询回应
    ...
    public const string NET_AGENT_QUERY_INFO_ACK            = "NET_AGENT_QUERY_INFO_ACK";           //查询我的推广信息回应
    public const string NET_AGENT_QUERY_SUB_AMOUNT_ACK      = "NET_AGENT_QUERY_SUB_AMOUNT_ACK";     //查询子账号数量回应
    public const string NET_AGENT_QUERY_SUB_LIST_ACK        = "NET_AGENT_QUERY_SUB_LIST_ACK";       //查询子账号的贡献列表回应
    public const string NET_AGENT_QUERY_USER_ACK            = "NET_AGENT_QUERY_USER_ACK";           //查询某个玩家详细贡献回应
    public const string NET_MAIL_GIFT_SEND_ACK              = "NET_MAIL_GIFT_SEND_ACK";             //赠送邮件礼物回应            
    public const string NET_MAIL_GIFT_LOG_QUERY_ACK         = "NET_MAIL_GIFT_LOG_QUERY_ACK";        //礼物赠送日志查询回应
    public const string NET_LAST_GAME_QUERY_ACK             = "NET_LAST_GAME_QUERY_ACK";            //上次未结束的游戏查询回应
    public const string NET_RANK_REWARD_FETCH_ACK           = "NET_RANK_REWARD_FETCH_ACK";          //领取排行榜奖励回应
    public const string NET_TREASURE_GAME_BALANCE_ACK       = "NET_TREASURE_GAME_BALANCE_ACK";      //聚宝盆小游戏结算回应
    public const string NET_GET_SERVICE_ACK                 = "NET_GET_SERVICE_ACK";                //获取客服信息
    public const string NET_MAGIC_TRADE_IN_ACK              = "NET_MAGIC_TRADE_IN_ACK";             //弹头兑换魔力值回应
    public const string NET_MAGIC_TRADE_OUT_ACK             = "NET_MAGIC_TRADE_OUT_ACK";            //魔力值兑换弹头回应
    public const string NET_WARHEAD_EXCHANGE_ACK            = "NET_WARHEAD_EXCHANGE_ACK";           //弹头交换回应
    public const string NET_ROOM_SET_PASSWORD_ACK           = "NET_ROOM_SET_PASSWORD_ACK";          //房间设置密码回应
    //#endregion
    ...
    public const string ROOM_FISH_WHEEL3                    = "ROOM_FISH_WHEEL3";                   //号角召唤boss死亡
    ...
    public const string ROOM_TREASURE_GAME_ENTER            = "ROOM_TREASURE_GAME_ENTER";           //进入聚宝盆小游戏
    public const string ROOM_ENTER_TREASURE_OHTER_PLAYER    = "ROOM_ENTER_TREASURE_OHTER_PLAYER";   //其他玩家进入聚宝盆游戏
    public const string ROOM_EXIT_TREASURE_OHTER_PLAYER     = "ROOM_EXIT_TREASURE_OHTER_PLAYER";    //其他玩家进入聚宝盆游戏
    public const string ROOM_STAY_IN_TREASURE_GAME_SEAT     = "ROOM_STAY_IN_TREASURE_GAME_SEAT";    //正在聚宝盆游戏内的座位id
    public const string ROOM_FORCE_CANCEL_ALL_STATE         = "ROOM_FORCE_CANCEL_ALL_STATE";        //强制关闭所有技能
    public const string ROOM_ALL_PLAYER_SET_READY           = "ROOM_ALL_PLAYER_SET_READY";          //进入渔场时所有玩家数据加载完毕
    public const string ROOM_HORN_BOSS_BORN                 = "ROOM_HORN_BOSS_BORN";                //号角召唤Boss出生
    public const string ROOM_HORN_BOSS_DEAD                 = "ROOM_HORN_BOSS_DEAD";                //号角召唤Boss死亡
    public const string ROOM_HORN_WHEEL_RESULT_SHOW         = "ROOM_HORN_WHEEL_RESULT_SHOW";        //号角轮盘能量兑换结果通知
    ...
    public const string CALL_LUA = "CALL_LUA";

    public const string GAMECONTROL_QUIT_SCENE= "GAMECONTROL_QUIT_SCENE";                    
}